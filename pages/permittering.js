...
import VeilederInnhold from '../components/permittering/veileder-innhold'
...
import '../styles.less'
import FaqData from '../lib/data/permittering-faq.json'
import LinksData from '../lib/data/permittering-linker.json'
...
const Permittering = (props) => {
  ...
  return (
    <Container title={t['app-head-title']} Ui={Ui}>
      <main style={{ minWidth: '50%' }}>
        <Ui.Nav.Panel className='w-100'>
          <Ui.Nav.Innholdstittel className='title m-4'>
            {t['permittering-page-title']}
          </Ui.Nav.Innholdstittel>
